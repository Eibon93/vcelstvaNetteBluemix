...
/**
 * Továrna na formulář pro změnu e-mailové adresy aktuálního uživatele.
...
class EmailChangeFormFactory
{
	...
	public function create()
	{
		...
		$form->addProtection();
		$form->addHidden('id');
		$form->addUserEmail('newEmail', $form['id']);
	...
	/**
	 * Přijme data z formuláře a odešle aktuálnímu uživateli pokyny pro změnu e-mailové adresy.
	 *
	 * @param Form $form
	...
	public function onFormSubmitted(Form $form, ArrayHash $values)
	{
		try {
			...
			$this->userManager->verifyEmailReset($user, $values->newEmail);
